...
INSERT INTO `cron_config` (`cron_config_id`, `name`, `remark`, `status`, `start_time`, `interval_time`, `type`, `path`, `module`, `sort`, `create_time`) VALUES
	(1, '发送邮件', '我是测试的邮件群发任务', 0, '2018-05-28 11:53:19', 1, 1, 'email/send', 'Email', 1, '2018-05-28 11:53:19'),
	(2, '发送短信', '我是测试的短信群发任务', 0, '2018-05-28 11:53:19', 1, 1, 'email/send', 'Notic', 1, '2018-05-28 11:53:19');
